// This file can be removed once http://jira.codehaus.org/browse/MNG-4333
// is applied.
    ...
    extends AbstractVersionTransformation
{
    ...
    protected String constructVersion( Versioning versioning,
                                       String baseVersion )
    {
        String rc = versioning.getLatest();
        // It is highly likeyly that the versioning.latest was not set.
        // But we can figure out the latest by looking at the versions..
        if( rc == null && versioning.getVersions()!=null ) {
            ComparableVersion latest = null;
            for (String s : versioning.getVersions()) {
                ComparableVersion comparableVersion = new ComparableVersion(s);
                if( latest==null || latest.compareTo(comparableVersion)<=0 ) {
